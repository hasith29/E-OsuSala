        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales for current orders -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">My Current Orders</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        count(Bill_item.quantity) as quantity ,sum(Bill_item.amount) as amountm,
                                        Bill_item.create_date FROM `Bill_item` ,Bill,Product,Generic
                                        WHERE Bill.customer_id = $customer_id AND Bill_item.bill_id = Bill.bill_id
                                         ...
                                         AND Bill.delivery_status != 'Delivered' GROUP BY Bill.bill_id";
                                        $cus = $conn->query($sql);
                                        if($cus){
