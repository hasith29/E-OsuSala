...
<!-- Search -->
            <div class="search-wrap">
                <div class="container">
                    ...
                    <form action="loggedCustomer.php" method="POST">
...
<!-- navbar first line icons to right -->
                    <?php
        ...
        <div class="site-blocks-cover" style="background-image: url('images/home2.jpg');">
          ...
          <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="col-md-6 col-lg-2">
                      <img text-align="left" width="500" height="300" src="images/home_image.png" alt="Image">
                  </div>
              </div>
          </div>
        </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            while($row=$company->fetch_assoc()): 
                    ...
                    <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    <span class="tag">Sale</span>
                    <a href="shop-single.php?prod_id=<?php echo $row["product_id"] ?>"> <img width="250" height="250" src="images/product_0<?php echo $name;?>.png" alt="Image"></a>
                    <h3 class="text-dark"><a href="shop-single.php?prod_id=<?php echo $row["product_id"] ?>"><?php echo $row["name"];?></a></h3>
                    <p class="price">Rs. <?php echo $row["price"];?></p>
                </div>
