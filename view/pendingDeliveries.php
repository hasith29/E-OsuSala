                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">Pending Deliveries</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="IND1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        INNER JOIN Product ON Product.product_id = Awarded.product_id AND Awarded.status = 'Accepted'
                                        ");
                                        if ($rQ) {
