    ...
    <div class="container">
        ...
        <div class="row justify-content-center"
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <h1 class="h4 text-gray-900 mb-4 my-2">Create New Customer Account</h1>
                ...
                <div class="row" style="height: 500px;">
                    ...
                    <div class="col-lg-4">
                        <form action="" method="POST" id="frm_crete_customer">
                    ...
                    <div class="col-lg-4">
                        ...
                        ?>
                        <input type="hidden" class="form-control form-control-user" id="cus_id" placeholder="cus_id"
                            name="cus_id" value="<?php echo $cus_id ; ?>">
                            <?php if($cus_id){
                                echo '<button type="button" class="btn btn-primary btn-user btn-block" id="btn_create_cus"> Update
                                Account</button>';
                            }else{
                                echo '<button type="button" class="btn btn-primary btn-user btn-block" id="btn_create_cus"> Create
                                Account</button>';
                            }  ?>
...
<script>
$('#btn_create_cus').click(function(e) {

    e.preventDefault()
    let myForm = document.getElementById('frm_crete_customer');
    let formData = new FormData(myForm);

    $.ajax({
            url: '../model/ajax.php?action=save_customer',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
        ...
        .done(function(resp) {
            ...
            if (resp.code == 200) {
                ...
                alert_toast("Customer data successfully added", 'success');
                $('#frm_crete_customer').get(0).reset();
                setTimeout(function() {
                    var url = "login.php";
